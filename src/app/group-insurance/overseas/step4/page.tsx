...
export default function OverseasInsuranceStep4Page() {
  ...
  const handleFinalSubmit = () => {
    ...
    // 5단계로 이동
    window.location.href = '/group-insurance/overseas/step5';
  };
      ...
      <div className="speed_content">
        ...
        <div className="con01">
          <div className="bgcolor_white">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="dd tb ag_left">
                      레바논, 미얀마, 북한, 시리아, 아프가니스탄, 예멘, 이라크, 이란, 이스라엘, 파키스탄, 팔레스타인 자치구, 바레인, 사우디아라비아, 아랍에미리트공화국, 오만, 요르단, 카타르, 쿠웨이트
                    </td>
                  </tr>
                  <tr>
            ...
            <a
              href={`/pdf/${encodeURIComponent('2026.06 약관_Chubb 해외여행보험.pdf')}`}
              target="_blank"
              download="2026.06 약관_Chubb 해외여행보험.pdf"
            >
              <div className="Box_line03">
                <p className="txt">
                  해외여행보험 약관보기<span className="btn_view"></span>
                </p>
              </div>
            </a>
            <p className="sub_title_s ag_left pt10">해외여행 약관을 읽어보셨습니까?</p>
            <div className="ccs_tbl v2 ty2">
              <div className="ccs_tbl_cont">
                <div className="ccs_rdo_area">
                  <span className="ccs_inp_rdo">
              ...
              <div className="tourG_mat06">
                ...
                <div className="tourG_mat12">
                  <a
                    ...
                    download="2026.06 약관_Chubb 해외여행보험.pdf"
                  >
                    해외여행보험 약관보기<span className="tour2023_arr01"></span>
                  </a>
                </div>
