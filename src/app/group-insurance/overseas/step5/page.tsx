...
export default function OverseasInsuranceStep5Page() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // 대륙명 변환 (국가명은 popup과 동일한 continentPlaceLabels 사용)
      const travelRegion = step1Data.tourContinent ? (continentMap[step1Data.tourContinent] || null) : null;
      const travelCountry = getTourPlaceLabel(step1Data.tourContinent, step1Data.tourPlace) || null;
        ...
        <div className="speed_content">
          <div className="con01">
            <div className="tour2023_pc_menu_wrap tourG_mat05 tourG_mab05">
              ...
              <span className="menu on"><a href="/group-insurance/overseas/popup">해외여행자보험</a></span>
                ...
                <table className="specialB" border={1} cellSpacing={0}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="ddT ag_left">해외여행보험</td>
              ...
              <table className="specialB" border={1} cellSpacing={0}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="dd tb ag_left">해외여행보험</td>
                  </tr>
                  <tr>
