...
export default function LongStayInsuranceStep4Page() {
  ...
  const handleNextStep = () => {
    ...
    if (agree2 !== 'Y') {
      alert(agree2 === 'N' ? '죄송합니다. 고객님.\n실손의료보험 중복과 비례보상에 내용에 동의하지 않는 경우 여행보험에 가입하실 수 없습니다.' : '2번 항목의 실손 의료보험 계약체결을 위한 사전 동의를 해주세요.');
      return;
    }

    // 3. 여행보험 약관보기
    if (agree3 !== 'Y') {
      alert(agree3 === 'N' ? '죄송합니다. 고객님.\n해당약관을 읽고 확인 하신 다음 여행보험에 가입하실 수 없습니다.' : '3번 항목의 여행보험 약관보기를 읽어보고 선택해주세요.');
      return;
    }

    // 4. 여행보험 가입시 알아두어야 할 사항
    if (agree4 !== 'Y') {
      alert(agree4 === 'N' ? '죄송합니다. 고객님.\n여행보험 가입시 알아두어야 할 사항을 숙지하고 동의하셔야 여행보험에 가입하실 수 없습니다.' : '4번 항목의 여행보험 가입시 알아두어야 할 사항을 읽어보고 선택해주세요.');
      return;
    }
  ...
  const handleFinalSubmit = () => {
    ...
    // 5단계로 이동
    window.location.href = '/group-insurance/longstay/step5';
  };
      ...
      <div className="speed_content">
        ...
        <div className="con01">
          <div className="bgcolor_white">
            ...
            <a
              href="/pdf/해외장기체류보험_약관.pdf"
              target="_blank"
              download="해외장기체류보험_약관.pdf"
            >
              <div className="Box_line03">
                <p className="txt">
                  해외장기체류보험 약관보기<span className="btn_view"></span>
                </p>
              </div>
            </a>
            <p className="sub_title_s ag_left pt10">해외장기체류 약관을 읽어보셨습니까?</p>
            <div className="ccs_tbl v2 ty2">
              <div className="ccs_tbl_cont">
                <div className="ccs_rdo_area">
                  <span className="ccs_inp_rdo">
          ...
          <div className="tour2023_pcBox_Layer" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="tour2023_pcBox_top01">
              <p className="tour2023_pcBox_tit01">
                ...
                <a className="close" href="#" onClick={(e) => { e.preventDefault(); setShowFinalModal(false); }}></a>
            </div>
            {/* 본문 */}
              ...
              <div className="tourG_mat06">
                ...
                <div className="tourG_mat12">
                  <a
                    ...
                    download="해외장기체류보험_약관.pdf"
                  >
                    해외장기체류보험 약관보기<span className="tour2023_arr01"></span>
                  </a>
                </div>
