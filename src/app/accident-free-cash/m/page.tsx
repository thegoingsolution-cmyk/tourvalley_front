...
export default function MobileAccidentFreeCashPage() {
  const router = useRouter();

  return (
    <div className="accident-free-cash-mobile">
      ...
      <div className="prow_01">
        ...
        <div className="tour2023_pcBox_txt03">
          <p className="tour2023_cashInfo_txt01">보험료의 10% 적립</p>
          <p className="tour2023_cashInfo_txt02">(최대 30,000원)</p>
          <p className="tour2023_cashInfo_txt03">
            사고없이 다녀오셨다면<br />
            투어밸리 무사고캐시를 적립하세요.<br />
            재가입할 때 그만큼 보험료를 아낄 수 있습니다.
          </p>
          <p className="tour2023_cashInfo_txt04">(개인고객에 한함)</p>
        ...
        <div className="tour2023PC_bg01">
          <section className="tour2023m_txt01">
