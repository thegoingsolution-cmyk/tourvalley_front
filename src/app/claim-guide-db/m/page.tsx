...
export default function MobileClaimGuideDBPage() {
  const [activeTab, setActiveTab] = useState(1);

  return (
    <div className="claim-guide-db-page mobile">
        ...
        <div className="container_w">
          <div className="container_box">
            <section className="bgcolor_white pt30 pb30 prow_01">
              <h2 className="sub_title_03 pb20 ag_left">DB손해보험</h2>
              ...
              <div className="con01 pt15 pb40 ag_left">
                <ul>
                  <li><strong><span className="font_blue">DB손해보험 고객센터:</span> 1588-0100</strong></li>
                  <li><strong><span className="font_blue">DB손해보험 보험금청구:</span> 1566-1040</strong></li>
                  <li><strong><span className="font_blue">DB손해보험 SOS 우리말지원서비스:</span> +82-2-3140-1722</strong></li>
                </ul>
              </div>
