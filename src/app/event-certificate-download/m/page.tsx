...
function EventCertificateDownloadContent() {
  ...
  const handleBusinessNumberInput = (index: 1 | 2 | 3, value: string) => {
    ...
    if (value.length === maxLength && index < 3) {
      const nextInput = document.getElementById(`resno${index + 1}-m`);
      if (nextInput) {
        nextInput.focus();
      }
    }
  ...
  return (
    <>
      ...
      <div className="event-certificate-download-mobile">
        <div className="ecdm-wrapper">
          <div className="ecdm-container">
            <div className="ecdm-content">
              <h1 className="ecdm-title">행사보험 가입증서 다운로드</h1>
              
              <form className="ecdm-form">
                <section className="ecdm-form-section">
                  {/* 법인(단체)명 */}
                  <div className="ecdm-form-group">
                    <label>법인(단체)명</label>
                    <input
                      type="text"
                      ...
                      maxLength={20}
                      placeholder="법인(단체)명"
                      className="ecdm-input"
                    />
                  </div>

                  {/* 사업자번호 */}
                  <div className="ecdm-form-group ecdm-business-number">
                    <label>사업자번호</label>
                    <div className="ecdm-business-inputs">
                      <input
                        type="tel"
                        id="resno1-m"
                        ...
                        maxLength={3}
                        placeholder=""
                        className="ecdm-input ecdm-input-small"
                      />
                      <input
                        type="tel"
                        id="resno2-m"
                  ...
                  <div className="ecdm-form-group">
                    ...
                    <input
                      ...
                      className="ecdm-input"
                    />
                    <div className="ecdm-button-wrapper">
                      <button
                        type="button"
                        onClick={checkInput}
                        className="ecdm-button ecdm-button-primary"
                      >
                        인증번호받기
                      </button>
                    </div>
                  ...
                  {/* 인증번호 입력 */}
                  {showSignArea && (
                    <div className="ecdm-form-group ecdm-sign-area">
                      <label>인증번호</label>
                      <input
                        type="tel"
...
export default function EventCertificateDownloadMobile() {
  return (
    <Suspense fallback={
      <div style={{ 
        display: 'flex', 
