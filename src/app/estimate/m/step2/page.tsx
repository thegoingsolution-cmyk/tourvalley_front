...
function MobileStep2PageContent() {
  ...
  return (
    <div className="bgcolor_white estimate-step2-mobile">
      ...
      <form name="inputForm" method="POST">
              ...
              <div className="tour2023_step_line tour">
                <ul className="tour2023_step">
                  <li className="tour2023_step01">
                    <div className="tour2023_step_num"><span className="tour2023_step_num01">1</span></div>
                    <div className="tour2023_step_txt">여행정보</div>
                  </li>
                </ul>
                <ul className="tour2023_step on">
                  <li className="tour2023_step01">
                    <div className="tour2023_step_num"><span className="tour2023_step_num01">2</span></div>
                    <div className="tour2023_step_txt">정보동의</div>
                  </li>
                </ul>
                <ul className="tour2023_step">
                  <li className="tour2023_step01">
                    <div className="tour2023_step_num"><span className="tour2023_step_num01">3</span></div>
              ...
              <div style={{ marginBottom: '30px' }}>
                ...
                <section className="tourGuard_Info">
                  ...
                  <div className="tourGuard_form_tt mag5 tourG_mab03">
                    ...
                    />
                    <div className="tourGuard_txt03">@</div>
                    <input
                      type="text"
                      id="email2"
                      name="email2"
        ...
        <input type="hidden" name="start_year" value={startDate ? startDate.split('-')[0] : ''} />
        <input type="hidden" name="start_month" value={startDate ? startDate.split('-')[1] : ''} />
        <input type="hidden" name="start_day" value={startDate ? startDate.split('-')[2] : ''} />
        <input type="hidden" name="start_date" value={startDate} />
        <input type="hidden" name="start_hour" value={startHour} />
        <input type="hidden" name="end_year" value={endDate ? endDate.split('-')[0] : ''} />
        <input type="hidden" name="end_month" value={endDate ? endDate.split('-')[1] : ''} />
        <input type="hidden" name="end_day" value={endDate ? endDate.split('-')[2] : ''} />
        ...
        <input type="hidden" name="join_site" value="FTM" />
...
export default function MobileStep2Page() {
  return (
    <Suspense fallback={
      <div style={{ 
        display: 'flex', 
