...
const coverageItems = [
  {
    title: '해외여행 중 휴대품손해(분실제외, 자기부담금1만원) (보상한도 기타 20만원)(단, 이동통신단말기 10만원)',
    description:
  ...
  {
    title: '해외여행 중 중대사고 구조송환비용(자기부담금:사고(질병)당 10만원 공제후 20%)',
    description:
