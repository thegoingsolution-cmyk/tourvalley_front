...
const coverageItems = [
  {
    ...
    description:
      '국내여행 중 상해 또는 질병의 치료목적으로 국내 의료기관에 산정특례대상질환이 아닌 질환으로 입원 또는 통원하여 「자기공명영상진단(MRI, MRA)」을 받은 경우, 본인이 실제로 부담한 비급여 의료비(조영제, 판독료 포함)에서 공제금액(1회당 3만원과 보장대상 의료비의 30% 중 큰 금액)을 뺀 금액을 보상한도(계약일부터 1년 단위로 각 상해·질병 치료행위를 합산하여 연간 300만원 한도)내에서 보상',
  },
];
    ...
    <div id="isbwrapper" className="agreement-wrapper">
      <header id="header">
        <div className="layer_header prow_01">
          <span className="layer_title">상해질병 비중증 비급여 자기공명영상진단</span>
          <a
            href="#"
            onClick={(event) => {
