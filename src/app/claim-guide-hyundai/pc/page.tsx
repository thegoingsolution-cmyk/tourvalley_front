...
export default function PCClaimGuideHyundaiPage() {
  const [activeTab, setActiveTab] = useState(1);
  const [showServiceModal, setShowServiceModal] = useState(false);
  const [showCashModal, setShowCashModal] = useState(false);

  return (
    <div className="claim-guide-hyundai-page">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className={activeTab === 4 ? 'on' : ''}>
                          <a href="#" onClick={(e) => { e.preventDefault(); setActiveTab(4); }}>항공편 지연에 따른 추가비용</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
