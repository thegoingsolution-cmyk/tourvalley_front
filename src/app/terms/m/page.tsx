...
export default function TermsMobilePage() {
  return (
    <div className="terms-mobile-page">
      <Header isMobile={true} />
      
      <div className="terms-container">
        <div className="terms-header">
          <h1 className="terms-title">Tourvalley 이용 약관</h1>
        </div>
        ...
        <section className="terms-content">
          <div className="terms-section">
            ...
            <p className="section-text">
              이 약관은 ㈜빨주노초파남보(이하 '회사'라 합니다)가 운영하는 투어밸리 홈페이지(이를 '플랫폼'이라 합니다)에서 제공하는 여행보험 및 기타 서비스(이하 '서비스'라 합니다)를 이용함에 있어서 회사와 이용자 간의 권리, 의무에 관한 사항, 서비스 이용조건과 절차 및 기타 필요한 사항을 규정함을 목적으로 합니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제2조 【용어의 정의】</h2>
            <p className="section-text">
              ...
              6. 이용자는 가입자가 직접 입력하거나 적법적인 동의 또는 위임절차에 의해 개인정보 제공되어야 하며 이와 관련하여 법적책임은 이용자에게 있습니다. 단, 회사의 책임이 있는 경우에는 회사가 법적책임을 집니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제3조 【약관의 효력 및 개정】</h2>
            <p className="section-text">
              ...
              ⑤ 본 약관에서 정하지 아니한 사항 및 본 약관의 해석에 관하여는 정부가 제정한 전자 거래소비자 보호지침, 관계법령 및 관례에 따릅니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제4조 【서비스 이용】</h2>
            <p className="section-text">
              이용자는 회사가 제공하는 서비스를 이용자의 용도에 맞게 이용할 수 있습니다. 여행자보험 가입서비스를 이용하기 위해서는 회사에서 요구하는 가입절차를 따라야 합니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제5조 【회원자격 취득】</h2>
            <p className="section-text">
              ...
              나. 회원에 가입한 후 서비스를 이용하지 않는 경우
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제6조 【단체(단체취급) 여행보험 가입】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제7조 【취소/환불/계약변경】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제8조 【정보의 제공 등】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제9조 【서비스 제공의 제한 등】</h2>
            <p className="section-text">
              ...
              ② 회사가 서비스의 이용을 제한하거나 중지한 때에는 그 사유 및 제한기간 등을 제3조 제1항의 방법으로 지체없이 회원에게 알리도록 합니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제10조 【회사의 의무】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제11조 【개인정보 보호정책】</h2>
            <p className="section-text">
              ① 회사는 모든 회원의 프라이버시를 존중하고 보호합니다.<br />
              ② 회사는 개인정보처리방침을 통해 회원의 개인정보를 보호합니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제12조 【회원의 의무】</h2>
            <p className="section-text">
              ...
              ⑤ 회원은 서비스의 이용권한 기타 이용계약상 지위를 타인에게 양도·증여할 수 없습니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제13조 【마일리지의 취득】</h2>
            <p className="section-text">
              ...
              ③ 여행보험에 가입하는 경우 적립되는 "마일리지"는 보험료가 최종 납입되고, 보험기간이 종료되는 날 24시에 적립됩니다.(단, 해외장기체류보험의 경우는 보험시작일 90일이 되는 날 24시에 적립됩니다.)
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제14조 【마일리지의 사용범위 및 시기】</h2>
            <p className="section-text">
              적립된 "마일리지"는 회원의 신청으로 10,000P 단위로 온라인 문화상품권, 모바일쿠폰 등 회사에서 제공하는 상품권으로 전환하여 사용가능합니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제15조 【마일리지 소멸】</h2>
            <p className="section-text">
              ① "마일리지"는 회원탈퇴를 하는 경우 자동 소멸됩니다. 회원으로 재가입하는 경우 기존의 "마일리지"는 다시 사용할 수 없습니다.<br />
              ② "마일리지" 유효기간은 12개월이며, 12개월이 지나면 소멸됩니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제16조 【계약 사항의 변경】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제17조 【해지】</h2>
            <p className="section-text">
              ① 회원이 이용계약을 해지하고자 하는 때에는 본인이 직접 온라인을 통해 회사에 신청하여야 합니다.<br />
              ② 회사는 제1항의 규정에 따른 해지신청이 접수된 즉시 서비스의 이용을 제한합니다.
            </p>
          </div>

          <div className="terms-section">
            <h2 className="section-title">제18조 【손해배상의 범위 및 청구】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제19조 【면책조항】</h2>
            <p className="section-text">
          ...
          <div className="terms-section">
            <h2 className="section-title">제20조 【분쟁의 해결】</h2>
            <p className="section-text">
              ① 회사와 회원은 서비스와 관련하여 분쟁이 발생한 경우에 이를 원만하게 해결하기 위하여 필요한 모든 노력을 하여야 합니다.<br />
              ② 제1항의 규정에도 불구하고, 동 분쟁으로 인하여 소송이 제기될 경우 동 소송은 서울 지방법원을 전속 관할법원으로 합니다.
            </p>
          </div>
        </section>
      </div>
