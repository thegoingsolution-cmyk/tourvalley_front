...
export default function MobileDomesticPage() {
  ...
  return (
    <div className="domestic-page-mobile">
      <Header isMobile={true} />
      
      <main className="domestic-content-mobile">
        {/* Background with city skyline */}
        <div className="domestic-background-mobile">
          <img
          ...
          <div className="form-container-mobile">
            <div className="form-card-mobile">
              ...
              <div className="form-header-mobile">
                <h1 className="form-title-mobile">국내여행자보험</h1>
